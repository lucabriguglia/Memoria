...
# emulator's Data Explorer using 1.7.0-cosmos-indexing-policy.json, or recreate the container.
#
# Usage:
#   ./1.7.0-cosmos-apply-indexing-policy.sh \
#       --resource-group rg-shop \
#       --account cosmos-shop \
#       [--database Memoria] \
#       [--container Domain] \
#       [--policy ./1.7.0-cosmos-indexing-policy.json] \
#       [--wait]
...
database="Memoria"
container="Domain"
policy="${script_dir}/1.7.0-cosmos-indexing-policy.json"
wait_for_reindex=0
