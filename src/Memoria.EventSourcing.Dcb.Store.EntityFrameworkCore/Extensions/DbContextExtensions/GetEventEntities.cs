...
public static partial class DcbDbContextExtensions
{
    ...
    /// </summary>
    public static Task<List<DcbEventEntity>> GetEventEntitiesFromPosition(this IDcbDbContext dcbDbContext,
    ...
    /// </summary>
    public static Task<List<DcbEventEntity>> GetEventEntitiesUpToPosition(this IDcbDbContext dcbDbContext,
    ...
    /// </summary>
    public static Task<List<DcbEventEntity>> GetEventEntitiesBetweenPositions(this IDcbDbContext dcbDbContext,
    ...
    /// </summary>
    public static Task<List<DcbEventEntity>> GetEventEntitiesFromDate(this IDcbDbContext dcbDbContext,
    ...
    /// </summary>
    public static Task<List<DcbEventEntity>> GetEventEntitiesUpToDate(this IDcbDbContext dcbDbContext,
    ...
    /// </summary>
    public static Task<List<DcbEventEntity>> GetEventEntitiesBetweenDates(this IDcbDbContext dcbDbContext,
